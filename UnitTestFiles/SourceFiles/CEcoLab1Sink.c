 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnSortStart(/* in */ struct IEcoLab1Events* me, 
                                                /* in */ size_t arraySize, 
                                                /* in */ int32_t maxValue) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
 ...
 *
 * <сводка>
 *   Функция OnProcessDigit
 * </сводка>
 *
 * <описание>
 *   Обработчик события обработки разряда
 * </описание>
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnProcessDigit(/* in */ struct IEcoLab1Events* me, 
                                                   /* in */ int32_t digitPosition,
                                                   /* in */ int32_t divisor) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    ...
    printf("[EVENT] Processing Digit #%d (divisor: %d)\n", digitPosition, divisor);
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnElementMove(/* in */ struct IEcoLab1Events* me, 
                                                  /* in */ int32_t value,
                                                  /* in */ size_t fromIndex,
                                                  /* in */ size_t toIndex) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    ...
    printf("  Move: value=%d from index %u -> to index %u\n", value, fromIndex, toIndex);
 ...
 *
 * <сводка>
 *   Функция OnDigitComplete
 * </сводка>
 *
 * <описание>
 *   Обработчик события завершения обработки разряда
 * </описание>
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnDigitComplete(/* in */ struct IEcoLab1Events* me, 
                                                    /* in */ int32_t divisor) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    ...
    printf("[EVENT] Digit processing complete (divisor: %d)\n\n", divisor);
...
int16_t ECOCALLMETHOD CEcoLab1Sink_OnSortComplete(/* in */ struct IEcoLab1Events* me) {
    ...
    printf("[EVENT] Radix Sort Completed!\n\n");
...
IEcoLab1VTblEvents g_x2D2E3B9214F248A6A09ECB494B59C795VTblEvents = {
    ...
    CEcoLab1Sink_OnProcessDigit,
    CEcoLab1Sink_OnElementMove,
    CEcoLab1Sink_OnDigitComplete,
    CEcoLab1Sink_OnSortComplete
};
